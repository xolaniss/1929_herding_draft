...
# 5.2 CSAD and CSSD -------------------------------------------------------
results_manuf_group_tbl <- cross_deviations_tbl(data = returns_manuf_group_tbl)
...
# 6.2 CSAD and CSSD -------------------------------------------------------
results_bus_group_tbl <- cross_deviations_tbl(data = returns_bus_group_tbl)
...
# 7.2 CSAD and CSSD -------------------------------------------------------
results_health_group_tbl <- cross_deviations_tbl(data = returns_health_group_tbl)
...
# 8.2 CSAD and CSSD -------------------------------------------------------
results_mines_group_tbl <- cross_deviations_tbl(data = returns_mines_group_tbl)
