...
equation <-  as_equation(c("CSAD_{t} = \\alpha + \\gamma_1R_{m, t}| + \\gamma_2|R_{m, t}| \\epsilon_{t}"))
estimates <- c(
  "\\alpha",
  "\\gamma_1 ",
  "\\gamma_2"
...
### Timevarying industry herding on fundamental information in crisis periods
...
### Timevarying herding on non-fundamental information in crisis periods
