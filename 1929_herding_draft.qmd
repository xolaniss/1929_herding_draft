...
equation_1 <-
  as_equation(
    c(
      "D^{herd} = \\lambda_0 +  \\lambda_1D^{party}  + \\lambda_2\\Gamma_{t} + \\epsilon_{t}"
    ),
    height = 0.05,
    unit = "cm"
  )
...
equation_2 <-
  as_equation(
    c(
      "D^{herd}_{FUND} = \\lambda_0 +  \\lambda_1D^{party} + \\lambda_2\\Gamma_{t} + \\epsilon_{t}"
    ),
    height = 0.05,
    unit = "cm"
  )
...
equation_3 <-
  as_equation(
    c(
      "D^{herd}_{NONFUND} = \\lambda_0 +  \\lambda_1D^{party} + \\lambda_2\\Gamma_{t} + \\epsilon_{t}"
    ),
    height = 0.05,
    unit = "cm"
  )
