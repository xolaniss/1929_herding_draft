...
## Industry herding in extreme markets
...
```{r}
#| label: fig-rol_bottom_market
#| fig-cap: "Industry herding in bottom market (5% of market returns) using a 250-day rolling window. Note: The perforated lines represents a 5% level of significance."
#| fig-height: 6
#| fig-width: 8
#| cache: false

extreme_market_herding$rol$rol_min_gg
...
crisis_tbl <- 
  ...
  "End" = c("1939-13-31", "2003-12-31", "2009-12-31", "2020-12-31")
) 
