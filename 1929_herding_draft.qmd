...
descriptives_tbl <- descriptives$descriptives_tbl %>% 
  ungroup() %>% 
  mutate(Category_Crisis = paste(Category, ": ", Crisis)) %>% 
  relocate(Category_Crisis, .before = Category) %>% 
  dplyr::select(-Category, -Crisis)

descriptives_tbl %>%
  as_grouped_data(groups = c("Category_Crisis")) %>%
  ...
  merge_at(i = 28, j = 1:7) %>%
  align(i = 28, align = "center") %>%
  merge_at(i = 31, j = 1:7) %>%
  align(i = 31, align = "center") %>%
  merge_at(i = 34, j = 1:7) %>%
  align(i = 34, align = "center") %>% 
  merge_at(i = 37, j = 1:7) %>% 
  align(i = 37, align = "center") %>% 
  merge_at(i = 40, j = 1:7) %>%
  align(i = 40, align = "center") %>%
  merge_at(i = 43, j = 1:7) %>%
  align(i = 43, align = "center") %>%
  merge_at(i = 46, j = 1:7) %>%
  align(i = 46, align = "center") %>%
  merge_at(i = 49, j = 1:7) %>%
  align(i = 49, align = "center") %>%
  merge_at(i = 52, j = 1:7) %>%
  align(i = 52, align = "center") %>% 
  merge_at(i = 55, j = 1:7) %>% 
  align(i = 55, align = "center") %>% 
  merge_at(i = 58, j = 1:7) %>%
  align(i = 58, align = "center") %>%
  merge_at(i = 61, j = 1:7) %>%
  align(i = 61, align = "center") %>%
  merge_at(i = 64, j = 1:7) %>%
  align(i = 64, align = "center") %>%
  merge_at(i = 67, j = 1:7) %>%
  align(i = 67, align = "center") %>%
  merge_at(i = 70, j = 1:7) %>%
  align(i = 70, align = "center") %>% 
    merge_at(i = 73, j = 1:7) %>% 
  align(i = 73, align = "center") %>% 
  merge_at(i = 76, j = 1:7) %>%
  align(i = 76, align = "center") %>%
  merge_at(i = 79, j = 1:7) %>%
  align(i = 79, align = "center") %>%
  merge_at(i = 82, j = 1:7) %>%
  align(i = 82, align = "center") %>%
  merge_at(i = 85, j = 1:7) %>%
  align(i = 85, align = "center") %>%
  merge_at(i = 88, j = 1:7) %>%
  align(i = 88, align = "center") %>% 
  autofit(add_w = 0.7)
