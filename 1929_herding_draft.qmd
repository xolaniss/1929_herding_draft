...
In summary the paper makes the following contributions to the literature. First, we provide new evidence on the presence of herding behaviour across different industry sectors in the US stock market. Second, we examine the determinants of herding behaviour across different sectors, focusing on the intersection of herding behaviour and market crisis periods. Third, we investigate the relationship between herding behaviour and political cycles, after taking market volatility into account. The paper is structured as follows. Section 2 presents the data and methodology. Section 3 presents the results and Section 4 concludes.
...
ggsave(here("Riza", "fig-rol_gen-1.pdf"), plot = rol_gg, width = 8, height = 4, dpi = 300)
```
...
ggsave(here("Riza", "fig-rol_crisis_gd-1.pdf"), plot = rol_gd_gg, width = 8, height = 4)
...
ggsave(here("Riza", "fig-rol_crisis_db-1.pdf"), plot = rol_db_gg, width = 8, height = 4)
```
...
ggsave(here("Riza", "fig-rol_crisis_fc-1.pdf"), plot = rol_fc_gg, width = 8, height = 4)
```
...
ggsave(here("Riza", "fig-rol_crisis_cv-1.pdf"), plot = rol_cv_gg, width = 8, height = 4)
```
...
ggsave(here("Riza", "fig-rol_fundamental-1.pdf"), plot = rol_fundamental_gg, width = 8, height = 4)
...
ggsave(here("Riza", "fig-rol_nonfundamental-1.pdf"), plot = rol_nonfundamental_gg, width = 8, height = 4)
```
...
ggsave(here("Riza", "fig-rol_fundamental_gd-1.pdf"), plot = rol_fund_gd_gg, width = 8, height = 4)
```
...
ggsave(here("Riza", "fig-rol_fundamental_db-1.pdf"), plot = rol_fund_db_gg, width = 8, height = 4)
```
...
ggsave(here("Riza", "fig-rol_fundamental_fc-1.pdf"), plot = rol_fund_fc_gg, width = 8, height = 4)
```
...
ggsave(here("Riza", "fig-rol_fundamental_cv-1.pdf"), plot = rol_fund_cv_gg, width = 8, height = 4)
```
...
ggsave(here("Riza", "fig-rol_nonfundamental_gd-1.pdf"), plot = rol_nonfund_gd_gg, width = 8, height = 4)
```
...
ggsave(here("Riza", "fig-rol_nonfundamental_db-1.pdf"), plot = rol_nonfund_db_gg, width = 8, height = 4)
```
...
ggsave(here("Riza", "fig-rol_nonfundamental_fc-1.pdf"), plot = rol_nonfund_fc_gg, width = 8, height = 4)
```
...
ggsave(here("Riza", "fig-rol_nonfundamental_cv-1.pdf"), plot = rol_nonfund_cv_gg, width = 8, height = 4)
...
ggsave(here("Riza", "fig-cons-1.pdf"), 
       plot = Consumer_durables_nondurables_wholesale_retail_some_services_group_equal_gg,
       width = 6, height = 4)
```
...
ggsave(here("Riza", "fig-health-1.pdf"), 
       plot = healthcare_medical_equipment_and_drugs_group_equal_gg,
       width = 6, height = 2)
```
...
ggsave(here("Riza", "fig-manufacturing-1.pdf"), 
       plot = manufacturing_energy_utilities_group_equal_gg,
       width = 6, height = 4)
```
...
ggsave(here("Riza", "fig-business-1.pdf"), 
       plot = business_equipment_telephone_and_television_transmission_group_equal_gg,
       width = 6, height = 4)
```
...
ggsave(here("Riza", "fig-mines-1.pdf"), 
       plot = mines_constr_bldmt_trans_hotels_bus_serv_entertainment_finance__group_equal_gg,
       width = 8, height = 6)
...
ggsave(here("Riza", "fig-famafrench-1.pdf"), 
       plot = fama_french_gg,
       width = 8, height = 4)
...
ggsave(here("Riza", "fig-volatility-1.pdf"), 
       plot = volatility_gg,
       width = 8, height = 2)
```
