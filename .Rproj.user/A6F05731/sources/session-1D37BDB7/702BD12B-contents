...
artifacts_returns_data <- list (
  ...
  groups = list(
    ...
    business_equipment_telephone_and_television_transmission_group_equal_tbl = business_equipment_telephone_and_television_transmission_group_tbl,
    business_equipment_telephone_and_television_transmission_group_weighted_tbl = business_equipment_telephone_and_television_transmission_group_tbl,
    healthcare_medical_equipment_and_drugs_group_tbl = healthcare_medical_equipment_and_drugs_group_tbl,
    healthcare_medical_equipment_and_drugs_group_tbl = healthcare_medical_equipment_and_drugs_group_tbl,
    mines_constr_bldmt_trans_hotels_bus_serv_entertainment_finance__group_tbl = mines_constr_bldmt_trans_hotels_bus_serv_entertainment_finance__group_tbl,
    mines_constr_bldmt_trans_hotels_bus_serv_entertainment_finance__group_tbl = mines_constr_bldmt_trans_hotels_bus_serv_entertainment_finance__group_tbl
  ),
  graphs = list(
